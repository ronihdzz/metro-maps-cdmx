...
file_ubicaciones_estaciones_estandarizado = (
    "datos/procesados/estaciones_ubicacion_2.xlsx"
)
...
tabla_ubicacion.to_excel(
    file_ubicaciones_estaciones_estandarizado, encoding="utf-8", index=False
)
