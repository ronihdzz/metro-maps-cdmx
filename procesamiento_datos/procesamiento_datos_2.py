...
for nombre_origen, nombre_destino in zip(
    tabla_separacion.Origen, tabla_separacion.Destino
):
...
tabla_separacion_limpia["longitud de interestacion"] = tabla_separacion[
