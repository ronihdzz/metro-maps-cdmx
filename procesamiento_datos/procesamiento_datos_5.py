...
print("Numero de estaciones registradas en tabla_separacion:",len(lista_nombres_estaciones_by_separacion))
...
print("Numero de estaciones registradas en tabla_ubicacion:",len(tabla_ubicacion.nombre))



print("D I F E R E N C I A S    E N  T R E    N O M B  R E  S      D  E     E  S T  A C I O  N E S ")
print("Nombre de estaciones que no hay en la tabla de separacion pero si en la de ubicacion")
...
print("Nombre de estaciones que no hay en la tabla de ubicacion pero si en la de separacion")
