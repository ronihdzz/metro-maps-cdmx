...
class App_Principal:
    ...
    # Es importante recordar que los por lo general libres son los puertos en el ragno de:
    # 1024 a 49151.
    SERVER_PORT = 3008
    ...
    def actualizarUbicaciones(cls, ubicacion):
        cls.ARCHIVO_UBICACIONES_ESTACIONES = (
            ubicacion + cls.ARCHIVO_UBICACIONES_ESTACIONES
        )
        cls.ARCHIVO_SEPARACION_ESTACIONES = (
            ubicacion + cls.ARCHIVO_SEPARACION_ESTACIONES
        )
